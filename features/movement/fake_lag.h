...
// ---------------------------------------------------------------
// Fake Lag â€” choke outgoing network packets to make your movement
...
//
// Modes:
//   Fixed   â€” always choke N ticks then send
//   Dynamic â€” choke more when moving, less when still
//   OnKey   â€” only fake lag while holding a key
// ---------------------------------------------------------------
...
namespace FakeLag
{
    ...
    // ---------------------------------------------------------------
    // ShouldChoke â€” decides whether to choke this tick.
    ...
    // ---------------------------------------------------------------
    // OnCreateMove â€” called from the CreateMove hook.
