...
// ---------------------------------------------------------------
// Backtrack â€” exploit lag compensation to aim at players' past
...
namespace Backtrack
{
    ...
    // ---------------------------------------------------------------
    // Record tick â€” called every frame, stores current head position
    ...
    // ---------------------------------------------------------------
    // Find best backtrack target â€” closest to crosshair from history
    // ---------------------------------------------------------------
    ...
    // ---------------------------------------------------------------
    // Render â€” draw backtrack position dots
    // ---------------------------------------------------------------
    inline void Render()
    {
