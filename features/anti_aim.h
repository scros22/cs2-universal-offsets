...
// ---------------------------------------------------------------
// Anti-Aim — desync your hitbox from your visual model to make
// you harder to hit. Works by writing to m_angEyeAngles on the
// local pawn (what other players see) while your actual view
// stays unchanged.
//
// Modes:
//   Spin    — rapidly rotate yaw (classic spinbot)
//   Jitter  — snap between opposite angles each tick
//   Down    — pitch down to 89 (makes headshots harder)
//   Desync  — offset body yaw from head yaw
// ---------------------------------------------------------------
...
namespace AntiAim
{
    ...
    inline void Tick()
    {
        ...
        __try {
            ...
            // Write fake angles to m_angEyeAngles (networked — other players see this)
