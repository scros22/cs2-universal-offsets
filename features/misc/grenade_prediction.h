...
// ---------------------------------------------------------------
// Grenade Prediction v2 â€” reads engine-computed trajectory data
...
namespace GrenadePrediction
{
    ...
    // Grenade physics constants (Source 2 â€” fallback sim only)
    ...
    // Process a single entity â€” called from __try block
