...
// ---------------------------------------------------------------
// Sound ESP â€” draws directional indicators showing where enemy
...
namespace SoundESP
{
    ...
    // ---------------------------------------------------------------
    // Tick â€” record footstep positions for moving enemies
    // ---------------------------------------------------------------
    inline void Tick()
    {
    ...
    // ---------------------------------------------------------------
    // Render â€” directional radar + footstep markers
    // ---------------------------------------------------------------
    inline void Render()
    {
        if (!cfg.enabled || !GameState::clientBase) return;
