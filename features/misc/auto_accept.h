...
// ---------------------------------------------------------------
// Auto-Accept â€” automatically accepts matchmaking when queue pops.
...
namespace AutoAccept
{
    ...
    inline void Tick()
    {
        ...
        // Queue is running and we're not connected â€” potential accept state
        ...
        if (mmRunning && notConnected)
        {
            ...
            if (!accepted)
            {
                ...
                {
                    // Fire accept â€” press Enter which accepts the Panorama prompt
                    INPUT inputs[2] = {};
