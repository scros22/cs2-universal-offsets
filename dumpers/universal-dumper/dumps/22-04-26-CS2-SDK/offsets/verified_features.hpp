...
namespace cs2::verified
{
    ...
    namespace No_Smoke
    {
        ...
        constexpr std::ptrdiff_t C_CSPlayerPawn__m_flLastSmokeOverlayAlpha = 0x0; // float — see schema dump for current offset; set 0
    }
    ...
    namespace No_Flash
    {
        constexpr std::ptrdiff_t C_CSPlayerPawn__m_flFlashDuration = 0x0; // float — see schema dump for current offset
        constexpr std::ptrdiff_t C_CSPlayerPawn__m_flFlashMaxAlpha = 0x0; // float — see schema dump for current offset
    }
    ...
    namespace FOV_Changer
    {
        ...
        constexpr std::ptrdiff_t CCSPlayer_CameraServices__m_iFOV = 0x0; // uint32 — see schema dump
        constexpr std::ptrdiff_t CCSPlayer_CameraServices__m_iFOVStart = 0x0; // uint32 — see schema dump
        constexpr std::ptrdiff_t C_CSPlayerPawn__m_pCameraServices = 0x0; // ptr — deref to reach m_iFOV/m_iFOVStart
    }
