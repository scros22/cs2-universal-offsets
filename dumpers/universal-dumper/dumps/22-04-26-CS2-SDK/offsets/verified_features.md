...
| `C_CSPlayerPawn` | `m_flLastSmokeOverlayAlpha` | `0x0` | `float` | see schema dump for current offset; set 0 |
...
| Class | Field | Offset | Type | Note |
|---|---|---|---|---|
| `C_CSPlayerPawn` | `m_flFlashDuration` | `0x0` | `float` | see schema dump for current offset |
| `C_CSPlayerPawn` | `m_flFlashMaxAlpha` | `0x0` | `float` | see schema dump for current offset |
...
| `CCSPlayer_CameraServices` | `m_iFOV` | `0x0` | `uint32` | see schema dump |
| `CCSPlayer_CameraServices` | `m_iFOVStart` | `0x0` | `uint32` | see schema dump |
| `C_CSPlayerPawn` | `m_pCameraServices` | `0x0` | `ptr` | deref to reach m_iFOV/m_iFOVStart |
