#!/usr/bin/env python3
"""Preprocess script for find-IGameSystem_SpawnGroupPrecache skill."""

from ida_preprocessor_scripts._igamesystem_dispatch_common import (
    preprocess_igamesystem_dispatch_skill,
)

SOURCE_YAML_STEM = "CSpawnGroupMgrGameSystem_SpawnGroupPrecache"
TARGET_SPECS = [
    {"target_name": "IGameSystem_SpawnGroupPrecache", "rename_to": "GameEvent_SpawnGroupPrecache"},
]
