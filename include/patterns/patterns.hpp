...
namespace pattern {
    ...
    namespace client {
        inline constexpr std::string_view ActionAbandonOngoingMatch = "40 57 48 83 EC 50 33 FF F6 05 B1 01 4D 01 01 0F";
        ...
        inline constexpr std::string_view ActionReconnectToOngoingMatch = "48 83 EC 38 F6 05 75 F2 4C 01 01 74 5F 48 8B 0D";
        ...
        inline constexpr std::string_view CAttributeStringInit = "48 8B C2 48 83 C8 02 45 84 C0 48 0F 44 C2 48 89 41 08 48 8D 05 D7 E2 42";
        ...
        inline constexpr std::string_view C_BaseEntity_StartParticleSystem = "48 89 5C 24 08 55 48 8B EC 48 83 EC 40 E8 0E 52";
        ...
        inline constexpr std::string_view C_EconItemView_GetStaticData = "40 56 48 83 EC 20 48 89 5C 24 30 48 8B F1 48 8B 1D 8B EA 33";
        inline constexpr std::string_view CacheParticleEffect = "4C 8B DC 53 48 81 EC 90 00 00 00 F2 0F 10 05 75";
        ...
        inline constexpr std::string_view ChangeModel = "40 53 48 83 EC 20 48 8B D9 4C 8B C2 48 8B 0D 9D";
        ...
        inline constexpr std::string_view Constructor = "48 89 5C 24 08 48 89 74 24 10 57 48 83 EC 30 48 8B F1 48 8B FA B9 50 00 00 00 E8 61";
        ...
        inline constexpr std::string_view CreateEntityByClassName = "4C 8D 05 ? ? ? ? 4C 8B CF BA 03 00 00 00 FF 15 8D EB 30";
        ...
        inline constexpr std::string_view CreateNewSubtickMoveStep = "48 89 5C 24 10 57 48 83 EC 20 33 DB 48 8B F9 48 85 C9 75 2D B9 38 00 00 00 E8 D2 A1";
        ...
        inline constexpr std::string_view CreateSubtickMoveStep = "48 89 5C 24 10 57 48 83 EC 20 33 DB 48 8B F9 48 85 C9 75 2D B9 38 00 00 00 E8 D2 A1";
        ...
        inline constexpr std::string_view DrawCrosshair = "48 89 5C 24 08 57 48 83 EC 20 48 8B D9 E8 BE 3C";
        ...
        inline constexpr std::string_view EmitPanoramaSound = "40 53 48 81 EC B0 00 00 00 0F 10 02 48 8B 05 75";
        ...
        inline constexpr std::string_view FindHudElement = "48 8D 15 ? ? ? ? 45 33 C0 B9 01 00 00 00 FF 15 92 13 B6";
        ...
        inline constexpr std::string_view GetAbsOrigin = "40 53 48 83 EC 20 48 8B 99 30 03 00 00 90 80 BB 10 01 00 00 00 74 08 48 8B CB E8 51";
        ...
        inline constexpr std::string_view GetBombsiteACenter = "48 89 5C 24 08 57 48 83 EC 20 48 8B F9 48 8B DA 48 8B 0D 51";
        inline constexpr std::string_view GetBombsiteBCenter = "48 89 5C 24 08 57 48 83 EC 20 48 8B F9 48 8B DA 48 8B 0D F1";
        ...
        inline constexpr std::string_view GetCustomPaintKitIndex = "48 89 5C 24 08 57 48 83 EC 40 8B 15 ? ? ? ? 48 8B F9 65 48 8B 04 25 58 00 00 00 B9 68 00 00 00 48 8B 04 D0 8B 04 01 39 05 92 22 34 01 0F 8F";
        inline constexpr std::string_view GetDirectChallengeCode = "48 83 EC 28 F7 05 D2 DB 1A 01 FF FF FF 3F 75 05";
        ...
        inline constexpr std::string_view GetLocalControllerById = "48 83 EC 28 83 F9 FF 75 17 48 8B 0D ? ? ? ? 48 8D 54 24 30 48 8B 01 FF 90 10 03 00 00 8B 08 48 63 C1 4C 8D 05 E6 BD";
        inline constexpr std::string_view GetLocalPawn = "48 83 EC 28 83 F9 FF 75 17 48 8B 0D ? ? ? ? 48 8D 54 24 30 48 8B 01 FF 90 10 03 00 00 8B 08 48 63 C1 4C 8D 05 E6 BD";
        inline constexpr std::string_view GetLocalPlayerController = "48 83 EC 28 83 F9 FF 75 17 48 8B 0D ? ? ? ? 48 8D 54 24 30 48 8B 01 FF 90 10 03 00 00 8B 08 48 63 C1 48 8D 0D 26 BE";
        ...
        inline constexpr std::string_view GetPlayerModel = "48 89 5C 24 08 48 89 74 24 10 57 48 83 EC 20 48 8B CA FF 15 C0 E1 A3 00";
        ...
        inline constexpr std::string_view GetRemovedAimpunch = "F2 0F 10 44 24 60 F2 0F 11 84 24 88 00 00 00 FF 15 3C F0 84";
        inline constexpr std::string_view GetRotatingOfficialMapGroupCurrentState = "48 81 EC 38 04 00 00 48 8B CA 48 8D 15 1F 34 B3";
        inline constexpr std::string_view GetServerName = "40 53 48 83 EC 20 48 8B D9 48 8B 0D ? ? ? ? 48 85 C9 74 35 E8 D6 12";
        ...
        inline constexpr std::string_view GetTournamentStageNameByIndex = "40 53 48 83 EC 20 8B 05 ? ? ? ? C1 E8 ? ? ? ? A8 01 74 79 48 8B 05 DB 57 49";
        ...
        inline constexpr std::string_view GetTournamentTeamNameByIndex = "40 53 48 83 EC 20 8B 05 ? ? ? ? C1 E8 ? ? ? ? A8 01 74 79 48 8B 05 7B 54 49";
        ...
        inline constexpr std::string_view GetUserCmdManager = "41 56 41 57 48 83 EC 48 48 8D 54 24 68 E8 EE 16";
        ...
        inline constexpr std::string_view GetWeaponInAccuracyRecoveryTime = "48 89 5C 24 08 57 48 83 EC 30 48 8B D9 E8 7E FA";
        ...
        inline constexpr std::string_view HasOngoingMatch = "0F B6 05 69 39 49 01 24 01 C3 CC CC CC CC CC CC";
        ...
        inline constexpr std::string_view InfoForResourceTypeCCompositeMaterial_TypeManager = "40 55 41 56 48 83 EC 68 48 8B EA 83 F9 06 0F 87 ? ? ? ? 48 63 C1 48 8D 15 02 9D";
        ...
        inline constexpr std::string_view InitTraceInfo = "40 55 41 55 41 57 48 83 EC 30 4C 8B 3D 07 60 F2";
        ...
        inline constexpr std::string_view IsLocalPlayerWatchingOwnDemo = "48 89 5C 24 08 48 89 6C 24 18 48 89 74 24 20 57 48 83 EC 20 48 8B 0D 75";
        ...
        inline constexpr std::string_view LevelShutdown = "48 83 EC 28 48 8B 0D ? ? ? ? 48 8D 15 F6 39";
        ...
        inline constexpr std::string_view MarkInterpLatchFlagsDirty = "40 53 56 57 48 83 EC 40 80 3D 8D 90 17 02 00 8B";
        ...
        inline constexpr std::string_view NoClipOnChange = "48 89 5C 24 10 48 89 74 24 18 48 89 7C 24 20 55 48 8B EC 48 83 EC 30 48 8D 05 32 B6";
        ...
        inline constexpr std::string_view OnGlowTypeChanged = "48 89 5C 24 08 48 89 74 24 10 57 48 83 EC 20 48 8B 05 B2 78";
        ...
        inline constexpr std::string_view ParticleCollection = "48 89 5C 24 08 57 48 83 EC 20 0F 28 05 FF AA 35";
        ...
        inline constexpr std::string_view PostProcessQuery = "48 89 5C 24 08 66 41 0F 6E C8 48 8D 1D 0F 03 F3";
        ...
        inline constexpr std::string_view QueueForceSubtickMove = "48 83 EC 28 8B 0D ? ? ? ? 65 48 8B 04 25 58 00 00 00 BA 68 00 00 00 48 8B 04 C8 8B 04 02 39 05 EB B6 98 01 0F 8F 82";
        ...
        inline constexpr std::string_view ReportHit = "40 53 48 83 EC 20 48 8D 05 ? ? ? ? 48 8D 59 08 48 89 01 F6 03 01 74 08 48 8B CB E8 CF 06 E8";
        ...
        inline constexpr std::string_view ScreenTransform = "48 89 74 24 10 57 48 83 EC 30 48 83 3D 0E BB 66";
        ...
        inline constexpr std::string_view SetDynamicAttributeValue = "48 89 6C 24 20 57 41 56 41 57 48 81 EC A0 00 00 00 48 8B FA C7 44 24 20 00 00 00 00 4D 8B F8 4C 8D 0D ? ? ? ? 48 8B E9 ? ? ? ? 07 12 01";
        inline constexpr std::string_view SetDynamicAttributeValue_raw = "48 89 6C 24 20 57 41 56 41 57 48 81 EC A0 00 00 00 48 8B FA C7 44 24 20 00 00 00 00 4D 8B F8 4C 8D 0D ? ? ? ? 48 8B E9 ? ? ? ? 07 12 01";
        ...
        inline constexpr std::string_view SetModel = "40 53 48 83 EC 20 48 8B D9 4C 8B C2 48 8B 0D 9D";
        ...
        inline constexpr std::string_view ShouldShowHudElements = "48 83 EC 28 BA FF FF FF FF 48 8D 0D ? ? ? ? E8 FB 6B 90";
        ...
        inline constexpr std::string_view ThinkReturn = "BA 04 00 00 00 FF 15 4E 6F 62 01 84 C0 0F 84 C2";
        ...
        inline constexpr std::string_view TraceInitInfo = "40 55 41 55 41 57 48 83 EC 30 4C 8B 3D 07 60 F2";
        ...
        inline constexpr std::string_view UntrustedFlagSetter = "74 26 C6 05 2A 02 08 02 01 33 C0 83 F8 01 74 18";
        ...
        inline constexpr std::string_view UpdateSkybox = "48 89 5C 24 08 57 48 83 EC 30 48 8B F9 E8 EE 26";
        inline constexpr std::string_view UpdateSubClass = "4C 8B DC 53 48 81 EC 90 01 00 00 48 8B 41 10 48";
        inline constexpr std::string_view UpdateTurningInAccuracy = "40 56 48 81 EC 80 00 00 00 48 8B F1 BA FF FF FF FF 48 8D 0D ? ? ? ? E8 E3 9B 07";
    ...
    namespace engine2 {
        ...
        inline constexpr std::string_view Cvar_RegisterConCommand = "48 89 5C 24 08 48 89 6C 24 10 48 89 74 24 18 57 48 83 EC 60 44 8B 15 B9";
        ...
        inline constexpr std::string_view Engine_RegisterConCommand = "48 89 5C 24 08 48 89 6C 24 10 48 89 74 24 18 57 48 83 EC 60 44 8B 15 B9";
        ...
        inline constexpr std::string_view ForceDemoRecordingFullUpdateAfterNextDeltaPacket = "48 89 5C 24 08 48 89 74 24 10 57 48 83 EC 20 48 8B 1D 2A 49";
        ...
        inline constexpr std::string_view GetScreenAspectRatio = "48 89 5C 24 08 57 48 83 EC 20 8B FA 48 8D 0D 8D";
    ...
    namespace server {
        ...
        inline constexpr std::string_view CreateEntityByName = "48 83 EC 48 C6 44 24 30 00 4C 8B C1 48 8B 0D DD";
        ...
        inline constexpr std::string_view LoopPostInitAllSystems_pEventDispatcher = "48 39 1D 90 7D 92 01 74 4D 39 05 E0 7C 92 01 7E";
        inline constexpr std::string_view NetworkStateChanged = "4C 8B C2 48 8B D1 48 8B 09 48 85 C9 74 35 48 8B";
        inline constexpr std::string_view PostThink = "40 57 48 81 EC 50 01 00 00 80 3D F1 7F D0 01 00";
        ...
        inline constexpr std::string_view UTIL_CreateEntityByName = "48 83 EC 48 C6 44 24 30 00 4C 8B C1 48 8B 0D DD";
